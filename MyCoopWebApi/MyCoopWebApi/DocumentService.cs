...
namespace MyCoopWebApi
{
    ...
    public class DocumentService
    {
            public static string StoragePath
        {
            get
            {
                var directory = HttpRuntime.AppDomainAppPath + WebConfigurationManager.AppSettings["storage-path"] + CurUserHostAddress + "\\";
        ...
        public static string DoUpload(HttpContext context)
        {
            ...
            var savedFileName = StoragePath + _fileName;
        ...
        public static string DoUpload(string fileUri)
        {
            ...
            try
            {
                using (var stream = req.GetResponse().GetResponseStream())
                {
                    ...
                    using (var fs = File.Open(StoragePath + _fileName, FileMode.Create))
                    {
