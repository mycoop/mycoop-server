...
namespace TeamLabOfficeAppsExample
{
    ...
    public class WebEditor : IHttpHandler
    {
        ...
        private static void Upload(HttpContext context)
        {
            ...
            try
            {
                context.Response.Write("{ \"filename\": \"" + DocumentService.DoUpload(context) + "\"}");
            }
            catch (Exception e)
            {
        ...
        private static void Convert(HttpContext context)
        {
            ...
            try
            {
                context.Response.Write(DocumentService.DoConvert(context));
            }
            catch (Exception e)
            {
                context.Response.Write("{ \"error\": \"" + e.Message + "\"}");
