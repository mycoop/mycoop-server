...
namespace ASC.Api.DocumentConverter
{
    ...
    public static class ServiceConverter
    {
        ...
        /// GetConvertedUri("http://helpcenter.teamlab.com/content/GettingStarted.pdf", ".pdf", ".docx", "http://helpcenter.teamlab.com/content/GettingStarted.pdf", false, out convertedDocumentUri);
        /// </example>
        /// <exception>
        /// </exception>
        ...
        /// <example>LFJ7 or "http://helpcenter.teamlab.com/content/GettingStarted.pdf"</example>
        ...
        {
            return WebConfigurationManager.AppSettings["files.docservice.tenantid"] ?? "TeamLabOfficeAppsExample";
        }

        private static string GetSKey()
        {
            return WebConfigurationManager.AppSettings["files.docservice.key"] ?? "Teamlab Office";
            ;
        }
